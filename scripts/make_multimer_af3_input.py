...
====================================
Stage 1a of the ABCfold IFB AGO1/MiRs pipeline:
...
configs/<complex>.yaml chain spec (see configs/ago1_fbw2.yaml and
configs/ago1_fbw2_mir168.yaml).
...
Usage (called by Snakemake rule `prepare_af3_input`):
    python scripts/make_multimer_af3_input.py \\
        ...
        --output            data/fold_inputs/ago1_fbw2_mir168/fold_input.json \\
        --n-replicas        20 \\
