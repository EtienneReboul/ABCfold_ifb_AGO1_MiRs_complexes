...
=============================
Stage 1b of the ABCfold IFB AGO1/MiRs pipeline — the "default run"
...
Usage (called by Snakemake rule `fetch_mmseqs2_msa`):
    python scripts/fetch_mmseqs2_msa.py \\
        --input-json   data/fold_inputs/ago1_fbw2/fold_input.json \\
        --output-json  data/fold_inputs/ago1_fbw2/fold_input.resolved.json \\
        --num-templates 20 \\
        --retries 3 \\
        --delay 8
"""
