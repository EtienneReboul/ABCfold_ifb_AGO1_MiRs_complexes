...
# =============================================================================
#
# Adapted verbatim (minus the --job-name) from the sibling
# ../../drb2_modelling/ABCfold_ifb_drbs_dcl4_ds_rna_complexes's submit_abcfold.sh,
# itself from ../../../NPF-ab-initio-modelling/ABCfold_NPF_pipeline's
...
# this pipeline has a fixed list of complexes, no apo/holo split).
#
...
# Batching — 6 complexes here; still 1/task (each is one full 6-backend run).
BATCH_SIZE=1
MAX_CONCURRENT=2
...
sbatch \
    ...
    $ACCOUNT_FLAG \
    $EXCLUDE_FLAG \
    --job-name="abcfold_ago1_mirs_array" \
